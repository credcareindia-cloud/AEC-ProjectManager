    ...
    <AppLayout>
      <div className="p-8">
        <div className="max-w-7xl">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-slate-900">QAQC - Quality Assurance & Quality Control</h1>
            <p className="text-slate-600 mt-2">{selectedProject?.name} - Model quality validation and testing</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-8">
            <Card className="p-6 border-slate-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900 mt-2">734</p>
                </div>
            ...
            <Card className="p-6 border-slate-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600 mt-2">565</p>
                </div>
            ...
            <Card className="p-6 border-slate-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600 mt-2">116</p>
                </div>
            ...
            <Card className="p-6 border-slate-200">
              ...
              <p className="text-3xl font-bold text-slate-900 mt-2">77%</p>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <Card className="p-6 border-slate-200">
              <h3 className="font-bold text-slate-900 mb-4">QAQC Results by Discipline</h3>
            ...
            <Card className="p-6 border-slate-200">
              <h3 className="font-bold text-slate-900 mb-4">Overall Test Distribution</h3>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    data={checklistData}
          ...
          <Card className="border-slate-200">
            <div className="p-6 border-b border-slate-200">
              <h3 className="font-bold text-slate-900">QAQC Checks Summary</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-slate-900">Check</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-slate-900">Passed</th>
                ...
                <tbody>
                  {qaqcChecks.map((check, idx) => (
                    <tr key={idx} className="border-b border-slate-200 hover:bg-slate-50">
                      <td className="px-6 py-4 text-sm font-medium text-slate-900">{check.check}</td>
